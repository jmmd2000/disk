import { createApp, h, hFragment } from "https://unpkg.com/disk-js";
const state = {
  currentTodo: "",
  edit: {
    idx: null,
...
function TodoItem({ todo, i, edit }, emit) {
  ...
  return isEditing
    ...
    : h("li", {}, [h("span", { on: { dblclick: () => emit("start-editing-todo", i) } }, [todo]), h("button", { on: { click: () => emit("remove-todo", i) } }, ["Done"])]);
}
